...
function entryIcon(entry) {
  if (entry.kind === "dir") return "\u{1F4C1}";
  ...
  if (kind === "text") {
    ...
    if (["json", "yaml", "yml", "toml"].includes(ext)) return "\u{1F9FE}";
    if (["go", "ts", "tsx", "js", "py", "rs", "java", "c", "cpp", "sh"].includes(ext)) return "\u{1F9E9}";
    return "\u{1F4C4}";
  }
  return "\u{1F9F7}";
}
...
function FilesView(props) {
  ...
  const [path, setPath] = (0, import_react.useState)(() => browseMemoryGet(memoryKey));
  ...
  const [preview, setPreview] = (0, import_react.useState)(void 0);
  const [mdView, setMdView] = (0, import_react.useState)("preview");
  ...
  const listElRef = (0, import_react.useRef)(null);
  ...
  (0, import_react.useEffect)(() => {
    ...
    fetchHome().then((home2) => {
      if (!cancelled) setPath(home2);
    }).catch((error) => {
      if (cancelled) return;
      setLoadState("error");
  ...
  const loadStateRef = (0, import_react.useRef)({ loading: false });
  ...
  function copyPath(entry) {
    navigator.clipboard?.writeText(entry.path).then(() => setActionNote(`\u5DF2\u590D\u5236\uFF1A${entry.path}`)).catch(() => setActionNote("\u590D\u5236\u5931\u8D25"));
  }
  function openInFinder(entry) {
    setActionNote("\u6B63\u5728\u6253\u5F00\u2026");
    openPathExternal(entry.path).then(() => setActionNote("\u5DF2\u5728\u7CFB\u7EDF\u6587\u4EF6\u7BA1\u7406\u5668\u4E2D\u6253\u5F00")).catch((error) => setActionNote(messageOf(error)));
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.lineRow, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.roots, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RootChip, { label: "\u{1F3E0} \u4E3B\u76EE\u5F55", onClick: () => home && navigate(home), disabled: !home }),
          quickRootChips(workspacesState, sessionsState, sessionId, navigate)
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.lineSpacer }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            ...
            children: showHidden ? "\u9690\u85CF\u70B9\u6587\u4EF6" : "\u663E\u793A\u9690\u85CF"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.toolButton, onClick: () => setRefreshTick((tick) => tick + 1), title: "\u5237\u65B0\u5F53\u524D\u76EE\u5F55", children: "\u27F3 \u5237\u65B0" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.lineRow, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.crumbs, children: [
          crumbs.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.crumbPath, children: currentPath || "\u2026" }),
          crumbs.map((crumb, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.crumbWrap, children: [
            index > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.crumbSep, children: "/" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.toolButton, onClick: handleJump, title: "\u8DF3\u8F6C\u5230\u8F93\u5165\u7684\u7EDD\u5BF9\u8DEF\u5F84", children: "\u8DF3\u8F6C" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.body, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.listStatus, children: [
              loadState === "loading" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.statusText, children: "\u52A0\u8F7D\u4E2D\u2026" }),
              loadState === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { ...styles.statusText, color: "#c0392b" }, children: [
                loadError,
                "\uFF08\u53EF\u70B9 \u27F3 \u91CD\u8BD5\uFF09"
              ] }),
              loadState === "idle" && visible.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.statusText, children: listing?.truncated ? "\u76EE\u5F55\u8FC7\u5927\uFF0C\u4EC5\u663E\u793A\u524D 2000 \u9879" : "\uFF08\u7A7A\u76EE\u5F55\uFF09" }),
              loadState === "idle" && visible.length > 0 && listing?.truncated && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.statusText, children: [
                "\u5171 ",
                entries2.length,
                "+ \u9879\uFF08\u4EC5\u663E\u793A\u524D 2000\uFF09"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.listInner, children: visible.map((entry) => {
              const index = visible.indexOf(entry);
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  title: entry.path,
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.rowIcon, children: entryIcon(entry) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.rowName, children: entry.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.rowMeta, children: entry.kind === "dir" ? "\u76EE\u5F55" : formatSize(entry.size) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.rowMeta2, children: formatMtime(entry.mtimeMs) }),
                    entry.kind === "file" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "button",
                      {
                        type: "button",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.listFooter, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.statusText, children: "\u2191\u2193 \u9009\u62E9 \xB7 \u21B5 \u6253\u5F00 \xB7 \u232B \u4E0A\u7EA7 \xB7 \u5207\u56DE\u300C\u5BF9\u8BDD\u300Dtab \u7EE7\u7EED\u804A\u5929" }) })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewPane, children: [
        preview && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewHeader, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.previewName, title: preview.entry.path, children: [
            entryIcon(preview.entry),
            " ",
            preview.entry.name
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.previewMeta, children: formatSize(preview.entry.size) }),
          preview.kind === "markdown" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: styles.segmented, role: "group", "aria-label": "\u9884\u89C8\u6A21\u5F0F", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.previewSpacer }),
          preview.kind !== "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.previewAction, onClick: () => copyPath(preview.entry), children: "\u590D\u5236\u8DEF\u5F84" }),
          preview.kind !== "error" && canOpenPath() && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.previewAction, onClick: () => openInFinder(preview.entry), children: "\u5728 Finder \u4E2D\u6253\u5F00" })
        ] }),
        actionNote && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.actionNote, children: actionNote }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewBody, children: [
          !selected && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewEmpty, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.previewEmptyIcon, children: "\u{1F440}" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "\u9009\u62E9\u5DE6\u4FA7\u6587\u4EF6\u9884\u89C8\u5185\u5BB9" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewEmptyHint, children: [
              "\u5F53\u524D\u76EE\u5F55\uFF1A",
              currentPath
            ] })
          ] }),
          preview?.kind === "image" && preview.url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: preview.url, alt: preview.entry.name, style: styles.image }),
          preview?.kind === "pdf" && preview.url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("iframe", { src: preview.url, title: preview.entry.name, style: styles.pdfFrame }),
          preview?.kind === "markdown" && mdView === "preview" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarkdownPreview, { html: preview.html ?? "", truncated: Boolean(preview.truncated) }),
          preview?.kind === "markdown" && mdView === "raw" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextView, { text: preview.text ?? "", truncated: Boolean(preview.truncated) }),
          preview?.kind === "text" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextView, { text: preview.text ?? "", truncated: Boolean(preview.truncated) }),
          (preview?.kind === "binary" || preview?.kind === "empty") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewEmpty, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.previewEmptyIcon, children: preview.kind === "empty" ? "\u{1F4C4}" : "\u{1F512}" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: preview.kind === "empty" ? "\u7A7A\u6587\u4EF6" : "\u4E8C\u8FDB\u5236\u6587\u4EF6\uFF0C\u65E0\u6CD5\u6587\u672C\u9884\u89C8" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.previewEmptyHint, children: "\u53EF\u7528\u300C\u5728 Finder \u4E2D\u6253\u5F00\u300D\u67E5\u770B\uFF0C\u6216\u590D\u5236\u8DEF\u5F84\u540E\u5728\u4F1A\u8BDD\u91CC\u8BA9\u6A21\u578B\u8BFB\u53D6\u3002" })
          ] }),
          preview?.kind === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.previewEmpty, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.previewEmptyIcon, children: "\u26A0\uFE0F" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: preview.error ?? "\u9884\u89C8\u5931\u8D25" })
          ] })
        ] })
      ] })
    ] })
...
function RootChip(props) {
  const { label, onClick, disabled } = props;
  if (disabled) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", style: styles.rootChip, onClick, title: label, children: label });
}
function quickRootChips(workspacesState, sessionsState, sessionId, navigate) {
  const items = Array.isArray(workspacesState?.items) ? workspacesState.items : [];
  const sid = sessionId ?? sessionsState?.current;
  const sessionCwd = sid ? sessionsState?.byId?.[sid]?.cwd : void 0;
  const chips = [];
  ...
  if (sessionCwd && !covered.has(sessionCwd)) {
    const title = (sid ? sessionsState?.byId?.[sid]?.displayTitle : void 0) ?? "\u5F53\u524D\u4F1A\u8BDD";
    chips.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RootChip, { label: `\u{1F4AC} ${String(title).slice(0, 30)}`, onClick: () => navigate(sessionCwd) }, `session-${sid ?? ""}`)
    );
  }
  return chips;
}
function TextView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.textWrap, children: [
    props.truncated && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.textTruncatedNote, children: [
      "\u26A0\uFE0F \u6587\u4EF6\u8F83\u5927\uFF0C\u4EC5\u9884\u89C8\u524D ",
      TEXT_PREVIEW_BYTES / 1024,
      " KB"
    ] }),
    lines.length > MAX_TEXT_LINES && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.textTruncatedNote, children: [
      "\u26A0\uFE0F \u5185\u5BB9\u8FC7\u957F\uFF0C\u4EC5\u663E\u793A\u524D ",
      MAX_TEXT_LINES,
      " \u884C"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: styles.textPre, children: shown.map((line, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.textLine, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.textLineNo, children: index + 1 }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.textLineBody, children: line || " " })
    ] }, index)) })
  ] });
}
function MarkdownPreview(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.mdWrap, children: [
    props.truncated && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.textTruncatedNote, children: [
      "\u26A0\uFE0F \u6587\u4EF6\u8F83\u5927\uFF0C\u4EC5\u6E32\u67D3\u524D ",
      TEXT_PREVIEW_BYTES / 1024,
      " KB"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: MD_CSS }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dfe-md", dangerouslySetInnerHTML: { __html: props.html } })
  ] });
}
var MD_CSS = `
