...
function FilesView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.lineRow, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.roots, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RootChip, { icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(House, { size: 12 }), label: "\u4E3B\u76EE\u5F55", onClick: () => home && navigate(home), disabled: !home }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", style: styles.toolButton, onClick: () => setRefreshTick((tick) => tick + 1), title: "\u5237\u65B0\u5F53\u524D\u76EE\u5F55", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.lineRow, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", style: styles.toolButton, onClick: handleJump, title: "\u8DF3\u8F6C\u5230\u8F93\u5165\u7684\u7EDD\u5BF9\u8DEF\u5F84", children: "\u8DF3\u8F6C" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.body, children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.listStatus, children: [
              loadState === "loading" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles.statusText, children: "\u52A0\u8F7D\u4E2D\u2026" }),
              loadState === "error" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { ...styles.statusText, color: "#c0392b" }, children: [
                loadError,
                "\uFF08\u53EF\u70B9 \u27F3 \u91CD\u8BD5\uFF09"
              ] }),
              loadState === "idle" && visible.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles.statusText, children: listing?.truncated ? "\u76EE\u5F55\u8FC7\u5927\uFF0C\u4EC5\u663E\u793A\u524D 2000 \u9879" : "\uFF08\u7A7A\u76EE\u5F55\uFF09" }),
              loadState === "idle" && visible.length > 0 && listing?.truncated && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: styles.statusText, children: [
                "\u5171 ",
                entries2.length,
                "+ \u9879\uFF08\u4EC5\u663E\u793A\u524D 2000\uFF09"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles.listInner, children: visible.map((entry) => {
              const index = visible.indexOf(entry);
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles.rowMeta, children: entry.kind === "dir" ? "\u76EE\u5F55" : formatSize(entry.size) }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles.listFooter, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles.statusText, children: "\u2191\u2193 \u9009\u62E9 \xB7 \u21B5 \u6253\u5F00 \xB7 \u232B \u4E0A\u7EA7 \xB7 \u5207\u56DE\u300C\u5BF9\u8BDD\u300Dtab \u7EE7\u7EED\u804A\u5929" }) })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewPane, children: [
        preview && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewHeader, children: [
          ...
          preview.kind === "markdown" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: styles.segmented, role: "group", "aria-label": "\u9884\u89C8\u6A21\u5F0F", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                type: "button",
          ...
          preview.kind !== "error" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", style: styles.previewAction, onClick: () => copyPath(preview.entry), children: "\u590D\u5236\u8DEF\u5F84" }),
          preview.kind !== "error" && canOpenPath() && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", style: styles.previewAction, onClick: () => openInFinder(preview.entry), children: "\u5728 Finder \u4E2D\u6253\u5F00" })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewBody, children: [
          !selected && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewEmpty, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: "\u9009\u62E9\u5DE6\u4FA7\u6587\u4EF6\u9884\u89C8\u5185\u5BB9" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewEmptyHint, children: [
              "\u5F53\u524D\u76EE\u5F55\uFF1A",
              currentPath
            ] })
          ] }),
          ...
          (preview?.kind === "binary" || preview?.kind === "empty") && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewEmpty, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: preview.kind === "empty" ? "\u7A7A\u6587\u4EF6" : "\u4E8C\u8FDB\u5236\u6587\u4EF6\uFF0C\u65E0\u6CD5\u6587\u672C\u9884\u89C8" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles.previewEmptyHint, children: "\u53EF\u7528\u300C\u5728 Finder \u4E2D\u6253\u5F00\u300D\u67E5\u770B\uFF0C\u6216\u590D\u5236\u8DEF\u5F84\u540E\u5728\u4F1A\u8BDD\u91CC\u8BA9\u6A21\u578B\u8BFB\u53D6\u3002" })
          ] }),
          preview?.kind === "error" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles.previewEmpty, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: preview.error ?? "\u9884\u89C8\u5931\u8D25" })
          ] })
        ] })
      ] })
    ] })
...
function RootChip(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", style: styles.rootChip, onClick, title: label, children: [
    icon && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles.rootChipIcon, children: icon }),
    label
  ] });
}
  ...
  for (const item of items) {
    ...
    chips.push(
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        RootChip,
        {
          icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Folder, { size: 12 }),
          label: item.title ?? "?",
  ...
  if (sessionCwd && !covered.has(sessionCwd)) {
    ...
    chips.push(
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        RootChip,
        {
          icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MessageSquare, { size: 12 }),
