...
var MD_CSS = `
.dfe-md { padding: 14px 18px 24px; font-size: 14px; line-height: 1.7; color: var(--dsw-alias-label-primary, #2b3446); overflow-wrap: break-word; }
.dfe-md > :first-child { margin-top: 0; }
.dfe-md > :last-child { margin-bottom: 0; }
.dfe-md h1, .dfe-md h2, .dfe-md h3, .dfe-md h4, .dfe-md h5, .dfe-md h6 { margin: 1.2em 0 0.5em; line-height: 1.35; color: var(--dsw-alias-label-primary, #1c2333); font-weight: 650; }
.dfe-md h1 { font-size: 22px; border-bottom: 1px solid var(--dsw-alias-border-l1, rgba(28,35,51,0.10)); padding-bottom: 0.3em; }
.dfe-md h2 { font-size: 18px; border-bottom: 1px solid var(--dsw-alias-border-l1, rgba(28,35,51,0.08)); padding-bottom: 0.25em; }
.dfe-md h3 { font-size: 16px; }
.dfe-md h4, .dfe-md h5, .dfe-md h6 { font-size: 14px; }
.dfe-md p { margin: 0.6em 0; }
.dfe-md a { color: var(--dsw-alias-link, #2d66f7); text-decoration: none; }
...
.dfe-md blockquote { margin: 0.8em 0; padding: 2px 14px; border-left: 3px solid rgba(45,102,247,0.45); color: var(--dsw-alias-label-secondary, #5a6478); background: var(--dsw-alias-interactive-bg-hover, rgba(28,35,51,0.03)); border-radius: 0 6px 6px 0; }
.dfe-md code { font-family: "SF Mono", ui-monospace, Menlo, Consolas, monospace; font-size: 12.5px; background: var(--dsw-alias-interactive-bg-hover, rgba(28,35,51,0.07)); padding: 1px 5px; border-radius: 5px; color: var(--dsw-alias-label-primary, #b8336a); }
...
.dfe-md pre code { background: transparent; padding: 0; color: var(--dsw-alias-label-primary, #2b3446); font-size: 12.5px; line-height: 1.6; }
...
.dfe-md hr { border: none; border-top: 1px solid var(--dsw-alias-border-l1, rgba(28,35,51,0.12)); margin: 1.2em 0; }
